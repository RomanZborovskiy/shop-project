            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        ...
                        <a href={{route('roles.index')}} class="small-box-footer">Переглянути користувачів <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    ...
                                    <!-- /.direct-chat-infos -->
                                    <img class="direct-chat-img" src="/vendor/adminlte/dist/img/user1-128x128.jpg"
                                ...
                                <div class="direct-chat-msg right">
                                    ...
                                    <!-- /.direct-chat-infos -->
                                    <img class="direct-chat-img" src="/vendor/adminlte/dist/img/user3-128x128.jpg"
                                         alt="message user image">
                                    <!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                 src="/vendor/adminlte/dist/img/user1-128x128.jpg" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/28/2015</small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                 src="/vendor/adminlte/dist/img/user7-128x128.jpg" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/23/2015</small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                 src="/vendor/adminlte/dist/img/user3-128x128.jpg" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/20/2015</small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                 src="/vendor/adminlte/dist/img/user5-128x128.jpg" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">2/10/2015</small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                 src="/vendor/adminlte/dist/img/user6-128x128.jpg" alt="User Avatar">
                          ...
                          <span class="contacts-list-name">
                            ...
                            <small class="contacts-list-date float-right">1/27/2015</small>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                 src="/vendor/adminlte/dist/img/user8-128x128.jpg" alt="User Avatar">
